...
def main(
    ...
    for epoch in range(steps):
        ...
        opt_state.hyperparams["learning_rate"] = loss_val * lr
    ...
    # Save.
    filename = f"250312_{setup}_{int(t_max)}_{lr}_{momentum}_{steps}_{cost_fn_power}_{seed}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_particles", type=int, default=1_000)
